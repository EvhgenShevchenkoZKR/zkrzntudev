      ...
      <div class="caption text-center">
        <div class="btn-group">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li><a href="javascript:trash('{{ $dir_name['short'] }}')"><i class="fa fa-trash fa-fw"></i> {{ Lang::get('Filemanager') }}</a></li>
          </ul>
        </div>
      ...
      <div class="caption text-center">
        <div class="btn-group ">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li><a href="javascript:download('{{ $file_name }}')"><i class="fa fa-download fa-fw"></i> {{ Lang::get('Filemanager') }}</a></li>
            <li class="divider"></li>
